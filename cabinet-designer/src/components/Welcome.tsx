...
const KEY = "jmrc.cabinet.welcomeShown.v1";
    ...
    <div className="dialog-backdrop" onClick={close}>
      <div className="dialog welcome" onClick={(e) => e.stopPropagation()}>
        <div className="dialog-head welcome-head">
          <div>
            <div className="welcome-title">JMRC — Cabinet Designer</div>
            <div className="welcome-sub">Catalog: OPPEIN RTA 2025 · 253 SKUs · Dealer list</div>
          </div>
        ...
        <div className="dialog-body welcome-body">
          <p className="welcome-lead">
            ...
            schedule. Every cabinet you drop is priced live from the OPPEIN dealer
            sheet against the finish and box you pick.
          </p>
