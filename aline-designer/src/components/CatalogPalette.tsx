...
export function CatalogPalette() {
  ...
  const tier = findFinish(catalog, settings.finishCode)?.tier ?? Object.keys(catalog.tiers)[0] ?? "";
  ...
  return (
    <aside className="palette">
      <header className="palette-header">
        ...
        <div className="palette-sub">ALINE 2025 · {catalog.products.length} SKUs</div>
